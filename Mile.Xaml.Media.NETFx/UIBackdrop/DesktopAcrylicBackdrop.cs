...
using Mile.Xaml.Media.Constants;
using Mile.Xaml.Media.WindowsAPI.PInvoke.Comctl32;
using Mile.Xaml.Media.WindowsAPI.PInvoke.Kernel32;
...
namespace Mile.Xaml.Media.UIBackdrop
{
    public class DesktopAcrylicBackdrop : SystemBackdrop
    {
        ...
        private CompositionBrush BuildDesktopAcrylicEffectBrush(Compositor compositor, Color tintColor, float tintOpacity, float luminosityOpacity)
        {
            ...
            noiseBrush.Surface = LoadedImageSurface.StartLoadFromUri(new Uri(Path.Combine(AppContext.BaseDirectory, ResourcePaths.NoiseAsset)));
